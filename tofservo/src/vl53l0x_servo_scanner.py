...
if __name__ == "__main__":
    ...
    vl53l0xScanner = vl53l0xServoScanner(23, -85, 85, 2250, 750, 20, 0.5)

    vl53l0xScanner.reset_servo()
    time.sleep(0.5)

    while True:
        print (vl53l0xScanner.scan(reset=True))

    """
    while True:
        vl53l0xScanner.move_servo()
        dist = vl53l0xScanner.read_laser()
        print("d = %4d  a = %4d"%(dist, vl53l0xScanner.angle))
